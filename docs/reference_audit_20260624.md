...
- Verified that all 53 active citation keys are defined in `sn-bibliography.bib`.
...
- Added arXiv DOI metadata for arXiv-only public-corpus and preprint references: WildChat, LMSYS-Chat-1M, ShareChat, Handa et al., Tutor CoPilot and Neagu et al.
...
- Protected acronyms and proper names in BibTeX titles, including AI, LLM, ChatGPT, WildChat, LMSYS-Chat-1M, ShareChat, ICAP, RCT and T4.
