...
SWE-chat and ThoughtTrace were also processed with the same pipeline as feasibility and boundary checks. They are not part of the main six-setting analysis because SWE-chat provides almost no usable writing sample after filtering and ThoughtTrace remains small with near-saturated scaffolding, which limits stable support-association estimation.
