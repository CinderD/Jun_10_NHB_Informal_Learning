...
Panel a decomposes cognitively engaged user turns\revise{, where constructive engagement is nested within cognitive engagement rather than a separate category}; panel b reports percentages of user turns; panel c reports conversation-level shares. WC, WildChat; LMSYS, LMSYS Chat; SC, ShareChat.
}
