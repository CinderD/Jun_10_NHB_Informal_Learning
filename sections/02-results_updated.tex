...
\revise{Model/source breakdowns supported the same descriptive hierarchy (Supplementary Table~\ref{tab:section21_model_source_breakdown}).}
...
\revise{A pooled model/source sensitivity supported the same support-form ordering (Supplementary Table~\ref{tab:section24_support_form_model_source_sensitivity}).}
