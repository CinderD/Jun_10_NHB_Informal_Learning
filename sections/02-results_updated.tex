...
Numbers indicate scaffolded-minus-reference differences, except panels b and c, which report model estimates. Error bars in panel a show conversation-level bootstrap 95\% confidence intervals for the displayed group ratios; panels b and c show model-based 95\% confidence intervals. Bootstrap confidence intervals for the descriptive contrasts in panels a and d are reported in Supplementary Table~\ref{tab:key_contrast_significance}. WC, WildChat; LMSYS, LMSYS Chat; SC, ShareChat.
}
...
\textbf{a,} Overall probability of a constructive next user turn after scaffolded versus reference assistant turns; annotations show scaffolded-minus-reference differences.
...
Error bars in panel a show conversation-cluster bootstrap 95\% confidence intervals over adjacent assistant-to-user pairs; panel d reports adjacent-turn logistic models with conversation-cluster robust standard errors. Panel b is a descriptive state-conditioned probability display; corresponding bootstrap intervals are provided in the figure source data. WC, WildChat; LMSYS, LMSYS Chat; SC, ShareChat.
}
