...
\revise{A model/source breakdown of the Section~\ref{subsec:2.1} prevalence measures showed variation in magnitude but preserved this descriptive hierarchy: constructive engagement remained a selective subset of overall cognitive engagement across recoverable assistant-model or source-family levels (Supplementary Table~\ref{tab:section21_model_source_breakdown}).}
...
Task ecology provided a second source of variation. Across all three corpora, coding-oriented conversations showed higher cognitive and constructive engagement than writing-oriented conversations. Cognitive engagement ranged from 45.00--50.21\% in coding conversations, compared with 15.30--33.05\% in writing conversations; constructive engagement ranged from 5.44--15.17\% in coding and 1.53--5.18\% in writing. A conversation-level context model showed the same direction after including user framing, conversation-length bucket and dataset fixed effects, with coding task ecology positively associated with the presence of at least one constructive user turn (OR=1.89, 95\% CI 1.71--2.08, p$<.001$; Supplementary Table~\ref{tab:constructive_context_logit}). \revise{Replacing dataset fixed effects with recoverable assistant-model or source-family indicators preserved the same context patterns (Supplementary Table~\ref{tab:section22_model_source_sensitivity}).}
...
\revise{This support-form pattern was preserved in a pooled sensitivity restricted to scaffolded conversations that entered M1--M6 jointly and replaced dataset fixed effects with recoverable model/source indicators: feedback-like support, hinting and explaining remained positive, whereas instructing, modelling and questioning remained lower or negative (Supplementary Table~\ref{tab:section24_support_form_model_source_sensitivity}).}
