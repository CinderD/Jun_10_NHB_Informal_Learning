...
\latestrevise{Where model or service-source metadata were available, the main findings were not specific to a single assistant-model family (for example, GPT-4- versus GPT-3.5-class systems) or service source (for example, ChatGPT, Gemini or related platforms); the same substantive patterns held in metadata breakdowns and fixed-effect sensitivity checks (Supplementary Tables~\ref{tab:section21_model_source_breakdown}--\ref{tab:prior_state_support_form_interactions}).}


% \todayrevise{Where assistant-model or service-source metadata were available, supplementary checks preserved the substantive patterns reported below (Supplementary Tables~\ref{tab:section21_model_source_breakdown}, \ref{tab:section22_model_source_sensitivity}, \ref{tab:section23_model_source_sensitivity} and \ref{tab:section24_support_form_model_source_sensitivity}).}
