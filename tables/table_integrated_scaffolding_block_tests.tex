...
six task settings, \revise{metadata FE} & Broad scaffolded support after user/context controls & 509.7 (1) & $<.001$ \\
six task settings, \revise{metadata FE} & M1--M6 descriptors within scaffolded support & 829.8 (6) & $<.001$ \\
six task settings, \revise{metadata FE} & Full scaffolding block after user/context controls & 1339.6 (7) & $<.001$ \\
