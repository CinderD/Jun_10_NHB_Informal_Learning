...
\footnotesize
\textit{Note.} User framing is reported as the percentage of conversations with explicit learning-oriented framing. Cognitive, constructive and emotional engagement are percentages of user turns; scaffolded support is computed over assistant turns.
\end{minipage}
\end{table*}
