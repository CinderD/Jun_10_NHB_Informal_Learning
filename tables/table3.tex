...
\footnotesize
\textit{Note.} User framing is reported as the percentage of conversations with explicit learning-oriented framing. Cognitive, constructive and emotional engagement are percentages of user turns; scaffolded support is computed over assistant turns. \revise{Assistant turns refer to AI/LLM responses, so user-side and assistant-side percentages use different role-specific denominators.}
\end{minipage}
\end{table*}
