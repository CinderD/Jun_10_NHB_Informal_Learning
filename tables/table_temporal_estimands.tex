...
\tiny
\centering
\caption{\textbf{Temporal estimands used to characterize support--engagement coupling.} Main temporal analyses use adjacent turn pairs. Coarser before--after summaries are exploratory boundary checks because scaffolded turns are selected by task difficulty, user motivation and conversation trajectory.}
