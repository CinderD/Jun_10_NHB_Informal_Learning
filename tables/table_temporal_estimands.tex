...
\tiny
\centering
\caption{\textbf{Temporal estimands for adjacent-turn support--engagement coupling.} Main temporal analyses use adjacent turn pairs. Coarser before--after summaries are reported separately as descriptive within-conversation checks.}
