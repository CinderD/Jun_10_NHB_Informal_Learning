...
\revise{Interaction block} & six task settings, \revise{metadata FE} & Prior state $\times$ M1--M6 & LR $\chi^2_{18}=297.3$, $<.001$ \\
Interaction block & WildChat only, model FE & Prior state $\times$ M1--M6 & LR $\chi^2_{18}=186.0$, $<.001$ \\
\midrule
\revise{State-stratified metadata FE} & prior constructive & M1 feedback & 0.72 [0.64, 0.81], $<.001$ \\
