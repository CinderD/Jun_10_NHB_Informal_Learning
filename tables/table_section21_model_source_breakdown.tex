...
\scriptsize
\centering
\caption{\revise{\textbf{Model/source breakdown for Section~2.1 descriptive engagement measures.} Ranges summarize recoverable assistant-model or source-family levels with at least 100 conversations within each task setting. The full model/source rows, including passive, active, constructive, overall cognitive engagement, emotional expression and scaffolded-support percentages, are exported in the source CSV.}}\label{tab:section21_model_source_breakdown}
\setlength{\tabcolsep}{4pt}
\renewcommand{\arraystretch}{1.10}
\resizebox{0.94\textwidth}{!}{%
\begin{tabular}{lcccc}
\toprule
Setting & Model/source levels & Cognitive overall, \% & Constructive, \% & Scaffolded support, \% \\
\midrule
