...
\addlinespace
User-turn engagement & User turn with preceding local context. & \revise{One engagement label: none, passive, active or constructive; separate emotional-expression flag; rationale and boundary flags.} & \revise{Classify the user's observable contribution as acknowledgement, task-relevant follow-up or substantive testing, revision, diagnosis, critique or extension, and separately mark explicit emotional expression.} \\
\addlinespace
