...
\addlinespace
Conversation-level user framing & Opening user turn. & \texttt{learning\_intent}: intentional or unintentional; rationale. & Mark intentional framing only when the user explicitly oriented the exchange toward understanding, exploration, explanation, improvement or learning, not merely task completion. \\
\addlinespace
...
\footnotesize \textit{Note.} The table reports the constructs and output fields needed to interpret the labels; implementation controls are summarized in Supplementary Table~\ref{tab:annotation_implementation_controls}.
\end{minipage}
\end{table}
