...
\centering
\scriptsize
\caption{\textbf{Corpus-scale annotation implementation controls.} The table records the operational controls used when applying the annotation workflow to the analytic corpora. Exact prompt text, schemas, prompt versions, deployment identifiers, API versions and run manifests are archived with the reproducibility code.}
