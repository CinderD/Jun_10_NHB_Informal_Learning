...
User engagement & Active (\texttt{A}) & Task-relevant action, follow-up, application or manipulation of task material. & The user takes a task-relevant next step, but does not test, revise or extend an idea. \\
