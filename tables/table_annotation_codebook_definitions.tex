...
\midrule
User engagement & Passive (\texttt{P}) & Reception, acknowledgement or minimal continuation without visible transformation of the task, idea or plan under discussion. & Includes short confirmations or requests to continue; excludes task-relevant follow-up or reasoning. \\
User engagement & Active (\texttt{A}) & Task-relevant action, follow-up, application or manipulation of task material in the exchange. & The user takes a task-relevant next step, such as applying a suggestion, reformulating an artifact or requesting the next step, but does not test, revise or extend an idea. \\
