...
\scriptsize
\centering
\caption{\todayrevise{\textbf{Metadata sensitivity for Section~\ref{subsec:2.4} support-form models.} The sensitivity is restricted to conversations containing scaffolded support and enters the six non-exclusive support-form indicators jointly. Cells report odds ratios for constructive-turn rate with 95\% confidence intervals and two-sided p values from conversation-robust standard errors. This metadata check complements, but does not replace, the descriptive percentage-point support-form contrasts in Fig.~\ref{fig:support_form_supply}.}}\label{tab:section24_support_form_model_source_sensitivity}
\setlength{\tabcolsep}{5pt}
\renewcommand{\arraystretch}{1.10}
\resizebox{0.82\textwidth}{!}{%
\begin{tabular}{lcc}
\toprule
Support form & Dataset FE & \todayrevise{Metadata FE} \\
\midrule
...
\todayrevise{Metadata fixed effects} & -- & 39 \\
\bottomrule
\end{tabular}%
}
\end{table*}
