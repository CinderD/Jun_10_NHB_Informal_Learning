...
\textit{Panel A: retained sample and descriptive rates.}
...
\vspace{6pt}
\textit{Panel B: boundary-check interpretation.}

\vspace{2pt}
\begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{0.16\textwidth}>{\raggedright\arraybackslash}p{0.19\textwidth}>{\raggedright\arraybackslash}X@{}}
\toprule
