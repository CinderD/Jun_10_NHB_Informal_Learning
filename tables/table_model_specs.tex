...
\scriptsize
\centering
\caption{\textbf{Additional analytic model families and robustness checks.} These analyses qualify the main associations by support form, temporal scale and available \todayrevise{model or source metadata}.}
