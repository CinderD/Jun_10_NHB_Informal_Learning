...
\begin{tabular}{lccc}
\toprule
Predictor & Pooled dataset FE & \revise{Pooled metadata FE} & WildChat model FE \\
\midrule
...
\midrule
\revise{Metadata block} & Reference & LR $\chi^2_{41}=714.4$, $p<.001$ & LR $\chi^2_{13}=553.2$, $p<.001$ \\
\bottomrule
\end{tabular}%
}
\end{table*}
